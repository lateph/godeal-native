...
import kotlinx.android.synthetic.main.ce_fragment_select_card.*
 ...
 * [SelectCardFragment.OnFragmentInteractionListener] interface
...
//    private var listener: OnFragmentInteractionListener? = null
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.ce_fragment_select_card, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        btnSelect.setOnClickListener {
            it.findNavController().navigate(R.id.toInputData)
        }
    }
